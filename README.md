...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/location-finder)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/location-finder
```

A live public deployment of this template is available at [https://location-finder.templates.workers.dev](https://location-finder.templates.workers.dev)
